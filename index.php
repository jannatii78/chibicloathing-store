...
<head>
  ...
  <title>ChibiClothing.store</title>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php">Recommendation</a>
          </li>
        </ul>
...
<div class="col-lg-4">
 ...
 <img src="img/<?= $data['foto'] ?>" height="100px">
        <h5 class="fw-normal mt-4"><?= $data['nama'] ?></h5>
        <div class="d-flex justify-content-center align-items-center gap-1">
          <a class="btn btn-secondary d-grid" href="detail.php?id=<?= $data['id'] ?>">Lihat detail>></a>
        </div>
</div>
<?php }?>
